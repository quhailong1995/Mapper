package yui.bss.baoyin.mgr.impl.ext;
...
import yui.bss.baoyin.mgr.ext.BaseService;
...
public abstract class BaseServiceImpl<T> implements BaseService<T> {
    ...
    @Override
    public MyPage<T> selectByPage(MyPage<T> page, Example example ) throws Exception {
    ...
    @Override
    public MyPage<T> getPageCommon(MyPage<T> page , List<T> list) {
